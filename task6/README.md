...
└── requests.md               # Примеры API запросов
```
...
Впервые переиспользовал пакет из другого своего проекта (в 3.5 проекте сделал хороший логгер и добавил его в этот проект)
